...
`CM: This chunks looks good! I like that you included the explanation of why you picked the 0:40 range.`
...
`CM: Interesting how you approached this one! I didn't know that you use the lower.tail = option! I will try to incorporate that in the future.`
...
`CM: I love that you included the cumulative call probability to illustrate the ppois(8, 15, lower.tail = FALSE), it really helps visualizing that probability. I'll try to add one to mine!`
